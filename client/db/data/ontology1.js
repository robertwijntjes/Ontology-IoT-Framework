...
const vunerability = new ont_node({nodeName:"vulnerability",relationship:"UsedFor" ,connected_to:[], linked_to:"equipment",level:1,attributes:["vun_id","vun_name","equipment_id","feature"]})
