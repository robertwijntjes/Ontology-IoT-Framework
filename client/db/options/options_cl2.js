...
const {equipment,size} = require('../data/ontology2')
// Ontology Import

const option_1 = {
    method:'POST',
    url:'http://127.0.0.1:3000/interface/data',
    json: { Client:2 , Response:[tlnd_node_density(recursive("weakness",equipment),size) ]}
}

const option_2 = {
    method:'POST',
    url:'http://127.0.0.1:3000/interface/data',
    json: { Client:2 , Response:[tlnd_weight(recursive("weakness",equipment),size) ]}
}

const option_3 = {
    method:'POST',
    url:'http://127.0.0.1:3000/interface/data',
    json: { Client:2 , Response:[tlnd_dist(recursive("weakness",equipment)) ]}
}
