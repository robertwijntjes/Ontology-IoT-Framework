...
const option_1 = {
    ...
    json: { Client:2 , Response:[synonyms_list(recursive("weakness",ontology_2)) ]}
}

const option_2 = {
    method:'POST',
    url:'http://127.0.0.1:3000/interface/data',
    json: { Client:2 , Response:[attributes_list(recursive("weakness",ontology_2)) ]}
}

const option_3 = {
    method:'POST',
    url:'http://127.0.0.1:3000/interface/data',
    json: { Client:2 , Response:[antonyms_list(recursive("weakness",ontology_2)) ]}
}
