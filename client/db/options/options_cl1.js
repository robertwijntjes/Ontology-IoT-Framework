...
const option_1 = {
    ...
    json: { Client:1 , Response:[ancestor("equipment",equipment,[])],height:height}
}

const option_2 = {
    method:'POST',
    url:'http://127.0.0.1:3000/interface/data',
    json: { Client:1 , Response:[distance_center(recursive("equipment",equipment),size)],height:height}
}
